  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form name="frmRole" ng-submit="save(role)" novalidate="novalidate">
          <div class="box-body">
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <tr ng-repeat="menu in role.menus">
                      ...
                      <td><input type="checkbox" ng-model="menu.read"></td>
                      <td><input type="checkbox" ng-model="menu.insert"></td>
                      <td><input type="checkbox" ng-model="menu.update"></td>
                      <td><input type="checkbox" ng-model="menu.delete"></td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div class="box-footer">
            <button type="submit" class="btn btn-primary" ng-if="isDisabled" ng-disabled="frmRole.$invalid == isDisabled">Actualizar</button>
