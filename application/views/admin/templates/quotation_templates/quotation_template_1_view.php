...
<head>
    ...
    <title><?php echo $quotation->quotation_number; ?> - FIRMA DIGITAL</title>
    ...
    <header>
        <table width="100%" style="font-size: 12px;">
            <tr>
                ...
                <td width="50%" height="2cm" align="right" valign="middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td  valign="top" width="55%">
                            <?php echo $product->concept_name; ?> de <?php echo $product->amount; ?> <?php echo $product->product_name; ?> por 
                            <?php echo $product->quantity_year_name; ?>
                            <br><br>
            ...
            <table style="width: 100%; font-size: 12px;">
                ...
                <tr>
                    <td class="pb-4">
                        ...
                        Recuerde, por disposición de Sunat “los demás servicios gravados con el IGV” cuyo importe sea mayor a S/ 700.00 (incl. Igv.) está efecto a la detracción del 12%.<br><br>
                ...
                <tr>
                    <td class="pb-3">
                        <ul>
                            <li>Estándar X.509v3.</li>
                            <li>Tamaño de clave pública: 2048 bits.</li>
                            <li>Emitido por una entidad Webtrust (Entidad Certificadora AC CAMERFIRMA).</li>
                            <li>Verificación OCSP (On Line Certificate Status Protocol) y CRL (Certificate Revocation List) (24x7).</li>
                            <li>Permite firma digital (Propósito de uso).</li>
                            <li>El certificado raíz del certificado es parte del Microsoft Root Certificate Program y está reconocido por el Sistema</li>
                            <li>Operativo Windows XP, Vista, 7 y los principales navegadores web.</li>
                            <li>El certificado es cifrado con SHA256</li>
                            <li>Permiten trabajar con aplicaciones de firma digital</li>
                            <li>Permiten el uso en autenticación de aplicaciones.</li>
                        </ul>
                    </td>
                </tr>
                <tr>
