...
<head>
    ...
    <title><?php echo $quotation->quotation_number; ?> - DISPOSITIVO TOKEN</title>
...
<body>
    ...
    <main>    
        ...
        <table style="width: 100%; font-size: 12px;">
                ...
                <tr>
                    <td>Sr(a). <?php echo $quotation->contact_first_name; ?> <?php echo $quotation->contact_last_name; ?></td>
                </tr>
                <tr>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center" valign="top"><?php echo ++$key; ?></td>
                        <td class="text-center" valign="top" width="5%"><?php echo $product->amount; ?></td>
                        <td  valign="top" width="55%">
                            <?php echo $product->concept_name; ?> de <?php echo $product->amount; ?> <?php echo $product->product_name; ?>
                            <br><br>

                            <strong>Correo(s):</strong> <br>
                            <?php $mails = ($product->quotation_products_mails) 
                                        ? explode(",", $product->quotation_products_mails) 
            ...
            <table style="width: 100%; margin-bottom: 20px; font-size: 12px;">
                <tr>
                    <td style="padding-bottom: 15px; width: 100%;"><strong>Comentarios:</strong> <?php echo $quotation->observation; ?></td>
                </tr>
                <tr>
            ...
            <table style="width: 100%;font-size: 12px;">
                <tr>
                    <td style="width: 100%; border: 1px solid #000; padding: 5px 10px; text-align: center; font-weight: bold; font-style: italic;">El precio no incluye movilidad fuera de los siguientes distritos: Barranco, Chorrillos, Jesús María, 
                    Lince, Magdalena del Mar, Miraflores, Pueblo Libre, San Borja, San Isidro, San Luis, San Miguel, Santiago de Surco y 
                    Surquillo.</td>
                </tr>
            </table>
        </div>
        <div style="page-break-after: always;">
            ...
            <tr>
               ...
               <tr>
                ...
                <tr>
                    <td class="subtitle" style="width: 100%;">ESPECIFICACIONES TÉCNICAS</td>
                </tr>
                <tr>
                    <td class="pb-3">
                        <ul>
                            <li>Sistemas operativos compatibles: Windows Server 2008/R2, Windows Server 2012 and 2012 R2, Windows7, Mac OS, Linux, Windows 8, Windows 10</li>
                            <li>Navegadores Soportados: Internet Explorer, Google Chrome, Mozilla Firefox</li>
                            <li>API y Estándares de soporte: PKCS#11, Microsoft CAPI, PC/SC, X.509 v3 certificate storage, SSL v3, IPSec/IKE, MS minidriver, CNG</li>
                            <li>Capacidad de memoria: 80k</li>
                            <li>Soporte de especificaciones ISO: Soporte para especificaciones ISO 7816-1 a 4</li>
                            <li>Temperatura de funcionamiento: 0° C a 70° C (32° F a 158° F)</li>
                            <li>Temperatura de almacenamiento: -40° C a 85° C (32° F a 158°F)</li>
                            <li>Grado de humedad: 0-100% sin condensación</li>
                            <li>Certificado de resistencia al agua: IP X7 – IEC 60529</li>
                            <li>Conector USB: USB tipo A; Soporte USB 1.1 y 2.0 (velocidad máxima y alta velocidad)</li>
                            <li>Cubierta: Plástico moldeado duro, inviolable</li>
                            <li>Retención de datos de memoria: Al menos 10 años</li>
                            <li>Reescritura de celdas de memoria: Por lo menos 500.000</li>
                            <li>Algoritmos de seguridad: 
                                <ul>
                                    <li>Simétrico: 3DES (Triple DES), bit AES 128/192/256</li>
                                    <li>Hash: SHA1, SHA256</li>
                                    <li>RSA 1024-bit / 2048 bit</li>
                                    <li>Curvas elípticas: P-256, P-384</li>
                                </ul>
                            </li>
                            <li>Certificaciones de seguridad: FIPS 140-2 level 3 (SC chip and OS)</li>
                            <li>Plataforma de tarjeta inteligente: GemaltoUDCore 30 y Applet EToken</li>
                            <li>Administración: A través del programa SafeNet Autenticación Client Tools</li>
                            <li>Contraseñas: Pueden administrarse a través del driver.</li>
        ...
        <div style="page-break-after: never;">
            <table style="font-size: 12px;">
                <tr>
                    <td class="subtitle" style="width: 100%;">SOPORTE Y MANTENIMIENTO</td>
                </tr>
                ...
                <tr>
                    <td class="subtitle" style="width: 100%;">GARANTÍA</td>
                </tr>
                <tr>
                    <td class="pb-3">Un (01) año contra defectos de fábrica</td>
                </tr>
                <tr>
