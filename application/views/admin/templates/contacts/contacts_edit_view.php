  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form name="frmContact" ng-submit="saveContact(contact)" novalidate="novalidate">
          <div class="box-body">
            <div class="row">
            ...
            <div class="row">
                <div class="form-group col-md-3 required">
                    ...
                    <select class="form-control" ng-options="phone_code.id as (phone_code.country_name + '  +' + phone_code.code) for phone_code in phone_codes" ng-model="contact.phone_code_id" required>
          ...
          <div class="box-footer">
            <button type="submit" ng-if="isDisabled" ng-disabled="frmContact.$invalid == isDisabled" class="btn btn-primary" ng-disabled="disable">Actualizar</button>
