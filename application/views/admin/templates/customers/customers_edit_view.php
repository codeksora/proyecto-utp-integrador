  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form name="frmCustomer" ng-submit="save(customer)" novalidate="novalidate">
          <div class="box-body">
            <div class="row">
                <div class="form-group col-md-2">
                    <label>Tipo de documento</label>
                    <input class="form-control" type="text" ng-value="customer.document_type_name" readonly>
                </div>

                <div class="form-group col-md-2">
                    <label>Número de documento</label>
                    <div class="input-group input-group-md">
                        <input type="text" class="form-control" ng-value="customer.document_number" readonly>
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-info btn-flat" ng-if="isDisabledSearch" ng-click="searchOnSunatEdit(customer.document_number)"><i class="fa fa-search"></i></button>
                ...
                <div class="form-group col-md-5 required">
                    ...
                    <input class="form-control" type="text" ng-model="customer.name" required>
                </div>
          ...
          <div class="box-footer">
            <button type="submit" class="btn btn-primary" ng-if="isDisabled" ng-disabled="frmCustomer.$invalid == isDisabled">Actualizar</button>
