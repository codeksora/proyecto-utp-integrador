  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form name="frmUser" ng-submit="add(user)" novalidate="novalidate">
          <div class="box-body">
            <div class="row">
          ...
          <div class="box-footer">
            <button type="submit" class="btn btn-primary" ng-if="isDisabled" ng-disabled="frmUser.$invalid == isDisabled">Agregar</button>
