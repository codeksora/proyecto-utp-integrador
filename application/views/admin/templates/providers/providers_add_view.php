  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form name="frmProvider" ng-submit="add(provider)" novalidate="novalidate">
          <div class="box-body">
            <div class="row">
          ...
          <div class="box-footer">
            <button type="submit" class="btn btn-primary btn-flat" ng-if="isDisabledProviders" ng-disabled="frmProvider.$invalid == isDisabledProviders">AGREGAR</button>
