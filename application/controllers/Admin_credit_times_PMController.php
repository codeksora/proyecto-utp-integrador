...
class Admin_credit_times_PMController extends REST_Controller {
	...
	public function credit_times_get() {
        $this->response($this->Credit_times_model->get_all(), REST_Controller::HTTP_OK);
	}
