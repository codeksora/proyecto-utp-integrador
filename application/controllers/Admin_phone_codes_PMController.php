...
class Admin_phone_codes_PMController extends REST_Controller {
	...
	public function __construct() {
		...
		$this->load->model('Phone_codes_model');
	...
	public function phone_codes_get($id = NULL) {
		if($id != NULL):
			...
			$this->response($this->Phone_codes_model->get_all(), REST_Controller::HTTP_OK);
		endif;
	}
